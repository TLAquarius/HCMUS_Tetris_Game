...
void Menu::DrawMenu(Rectangle StartBox, Rectangle AboutBox, Rectangle HowToPlayBox) {
	BeginDrawing();
...
void Menu::HowToPlay() {
	...
	DrawText(TextFormat("CONTROL: USE ARROWS KEY TO MOVE THE PIECES, Z and X key for rotation."), 200, 180, 20, BLACK);
